...
public class ByteArray
{
    ...
    public ByteArray(byte[] defaultBytes, int offset, int count)
    {
        bytes = defaultBytes;
        capacity = defaultBytes.Length;
        initSize = defaultBytes.Length;
        readIdx = offset;
        writeIdx = offset + count;
    }
    ...
    public int WriteInt16(Int16 val)
    {
        ...
        bytes[writeIdx] = (byte)(val & 0xff);
        bytes[writeIdx+1] = (byte)(val >>8);
    ...
    public int WriteInt32(Int32 val)
    {
        ...
        bytes[writeIdx] = (byte)(val & 0xff);
        bytes[writeIdx + 1] = (byte)((val>> 8) & 0xff);
        bytes[writeIdx + 2] = (byte)((val >> 16) & 0xff);
        bytes[writeIdx + 3] = (byte)((val >> 24) & 0xff);
